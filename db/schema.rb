...
ActiveRecord::Schema.define(version: 20160811131425) do
  ...
  add_index "taggings", ["tag_id", "post_id"], name: "index_taggings_on_tag_id_and_post_id", unique: true, using: :btree
